...
VFS::VFS(const char* gameFolder) {
	...
	if (this->triggerVFSDLL) {
		this->OpenVFS = reinterpret_cast<OpenVFS_FUNCPTR>(GetProcAddress(reinterpret_cast<HMODULE>(this->triggerVFSDLL), "_OpenVFS@8"));
		this->CloseVFS = reinterpret_cast<CloseVFS_FUNCPTR>(GetProcAddress(reinterpret_cast<HMODULE>(this->triggerVFSDLL), "_CloseVFS@4"));
		...
		this->OpenFile = reinterpret_cast<OpenFile_FUNCPTR>(GetProcAddress(reinterpret_cast<HMODULE>(this->triggerVFSDLL), "_VOpenFile@8"));
		//this->RemoveFile = reinterpret_cast<RemoveFile_FUNCPTR>(GetProcAddress(this->triggerVFSDLL, "_VRemoveFile@8"));
		this->CloseFile = reinterpret_cast<CloseFile_FUNCPTR>(GetProcAddress(reinterpret_cast<HMODULE>(this->triggerVFSDLL), "_VCloseFile@4"));
		this->ReadFile = reinterpret_cast<ReadFile_FUNCPTR>(GetProcAddress(reinterpret_cast<HMODULE>(this->triggerVFSDLL), "_vfread@16"));
		this->GetFileSize = reinterpret_cast<GetFileSize_FUNCPTR>(GetProcAddress(reinterpret_cast<HMODULE>(this->triggerVFSDLL), "_vfgetsize@4"));
