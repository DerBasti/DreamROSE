			...
			public:
				class Request {
					...
					public:
						...
						const static WORD RESPAWN_TOWN = 0x756;
						...
						const static WORD USE_CONSUMABLE = 0x7A3;
				...
				class Response {
					...
					public:
						...
						const static WORD RETURN_TO_CHARSERVER = 0x71C;
						const static WORD REWARD_ZULIES = 0x71E;
						const static WORD REWARD_ITEM = 0x71F;
						const static WORD ADD_TO_ABILITY = 0x720;
						const static WORD CHANGE_ABILITY = 0x721;
						const static WORD UPDATE_QUEST_DATA = 0x723;
						const static WORD QUEST_ACTION = 0x730;
						const static WORD QUEST_ITEM = 0x731;
						const static WORD ASSIGN_ID = 0x753;
						const static WORD RESPAWN_AFTER_DEATH = 0x755;
						const static WORD WEIGHT = 0x762;
						const static WORD TERRAIN_COLLISION = 0x770;
						const static WORD CONVERT_MONSTER = 0x774;
						const static WORD SET_EMOTION = 0x781;
						const static WORD CHANGE_STANCE = 0x782;
						const static WORD LOCAL_CHAT = 0x783;
						const static WORD WHISPER_CHAT = 0x784;
